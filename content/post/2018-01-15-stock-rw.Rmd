...
Due to the lack of any economic theory, I wouldn't put much weight in this prediction but it would be easy to incorporate that into the random walk and the Monte Carlo simulation won't change.