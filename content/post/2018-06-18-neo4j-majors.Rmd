...
## Basic Counting
We'll start with some basic counting of courses and major structure. For each major, we list the number of courses required by that minor. This count only includes specific courses required such as *MAT-175*, if the minor requires either *MAT-175* or *MAT-275* that is an option group (or component) counted later.
