...
**UPDATE (6/19/2018)** The original version of this post used incorrectly loaded data that caused to "Core" of every major to have the same classes attached to it. This was noticed by my collegue Dave Rosoff and has been corrected.
