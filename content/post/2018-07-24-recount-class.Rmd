...
date: 2018-07-24
tags: ["R", "scrape", "rvest", "reproducibility"]
...
```
you're right! The link positions on the page changed slightly, but everything else works. Go ahead and compare the two.
