...
library(readr)
IDacs2015 <- read_csv("../../static/files/acs2015_census_tract_data.csv", col_types = cols(CensusTract = col_character())) %>% filter(State == "Idaho")
...
ggplot() + geom_polygon(data = MplotData, aes(x = long, y = lat, group = id,
        fill = pctMen)) +
