...
What about the false negatives (missed cases of emergent reducibility):
```{r fnTable}
FNnerRF.tab <- xtabs(FN~ner+mdl, data=confMats[confMats$mdl %in% c("rfs","rfp","rfpp","rfsq","knn"),], drop.unused.levels = TRUE)
kable(FNnerRF.tab)
```
